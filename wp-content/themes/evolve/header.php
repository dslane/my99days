...
<!--BEGIN #searchform-->
  ...
  <label class="searchfield" id="search_label_top" for="search-text-top"><input id="search-text-top" type="text" tabindex="1" name="s" class="search" onfocus="if (this.value == '<?php _e( 'Type your search', 'evolve' ); ?>') {this.value=''}" onblur="if(this.value == '') { this.value='<?php _e( 'Type your search', 'evolve' ); ?>'}" value="<?php _e( 'Type your search', 'evolve' ); ?>" /></label> 
  </div>
