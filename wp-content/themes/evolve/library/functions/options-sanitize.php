...
function evl_recognized_font_faces() {
	...
	$default = array_merge( evl_options_typography_get_os_fonts() , evl_options_typography_get_google_fonts() );
//asort($default);
	return apply_filters( 'evl_recognized_font_faces', $default );
}


function evl_recognized_font_faces1() {

		$default1 = evl_options_typography_get_os_fonts();
//asort($default);
	return apply_filters( 'evl_recognized_font_faces1', $default1 );
	
	
}
function evl_recognized_font_faces2() {

		$default2 = evl_options_typography_get_google_fonts();
//asort($default);
	return apply_filters( 'evl_recognized_font_faces2', $default2 );
	
	
}

function evl_options_typography_get_os_fonts() {
	// OS Font Defaults
	$os_faces = array(
...
function evl_options_typography_get_google_fonts() {
