...
$template_url = get_template_directory_uri(); 
  ...
  $evl_menu_background = evl_get_option('evl_disable_menu_back','1');
  $evl_social_color = evl_get_option('evl_social_color','blackwhite');
...
.container { min-width:960px;max-width:2400px;width:95%;margin:20px 3%;}
.hfeed { width: 57%;min-width:506px; }
.home .hfeed, .archive .hfeed, .single .hfeed, .page .hfeed, .page-template-blog-page-php .hfeed {margin-right:10px;}
...
.home .hentry .comment-count a, .archive .hentry .comment-count a, .search .hentry .comment-count a, .page-template-blog-page-php .hentry .comment-count a  {color:#bfbfbf;background:url('.$template_url.'/library/media/images/comment.png) 0 9px no-repeat;text-decoration:none;position:relative;bottom:-9px;border:none;padding:8px 10px 8px 18px;}
...
.home .hentry .comment-count, .archive .hentry .comment-count, .search .hentry .comment-count, .page-template-blog-page-php .hentry .comment-count {background:none!important;padding-right:0;}';
...
.home .hentry, .archive .hentry, .search .hentry, .page-template-blog-page-php .hentry {width:31%;float:left;margin-right:19px;padding-bottom:12px;}
@media screen and (max-width: 758px) {.home .hentry, .archive .hentry, .search .hentry, .page-template-blog-page-php .hentry {width:48%;} }
@media screen and (max-width: 524px) {.home .hentry, .archive .hentry, .search .hentry, .page-template-blog-page-php .hentry {width:292px;} }
.home .hentry .entry-content, .archive .hentry .entry-content, .search .hentry .entry-content, .page-template-blog-page-php .hentry .entry-content {font-size:13px;}
.entry-content {margin-top:25px;}
.home .odd0, .archive .odd0, .search .odd0, .page-template-blog-page-php .odd0 {clear:both;}
...
.menu-header {top:0;background: none!important;border: none!important;border-radius:0!important;-webkit-box-shadow:none!important;-moz-box-shadow:none!important;-box-shadow:none!important;box-shadow:none!important;}
.menu-header:before, .menu-header:after {content:none!important;}
.nav-menu li {
    border-left: 1px solid #e1e1e1;}
.nav-menu li.current-menu-item > a, .nav-menu li.current-menu-ancestor > a, .nav-menu li a:hover,.nav-menu li:hover > a {
